...
#define     _MAX_SPSkill_COUNT_             100          //最大職業專屬技能
...
#define Def_ObjectClass_QuestNPC_Total		 10000		// QuestNPC
...
enum PriceTypeENUM
{
	...
	EM_ACPriceType_GameMoney,
	EM_ACPriceType_AccountMoney,
	EM_ACPriceType_BonusMoney,
	EM_ACPriceType_ItemMoney1,		//必耳丁
	EM_ACPriceType_Honor,
	EM_ACPriceType_ItemMoney2,		//競技場點數(Arena)
...
enum GameObjectMagicShowTypeENUM
{
	...
	EM_GameObjectMagicShowType_Parabola,			// 拋物線(投擲)
...
enum MagicCheckFunctionENUM
{
	...
	EM_MagicCheck_Rand,//"亂數"									
	EM_MagicCheck_Self_Eq,//"自己裝備( 機率 , 裝備號碼 )"			
	EM_MagicCheck_Target_Eq,//"目標裝備( 機率 , 裝備號碼 )"			
	EM_MagicCheck_Self_EqType,//"自己裝備類型( 機率 , 裝備類型 )"			
	EM_MagicCheck_Target_EqType,//"目標裝備類型( 機率 , 裝備類型 )"			
	EM_MagicCheck_Self_Item,//"自己物品( 機率 , 物品 or 重要物品 )"	
	EM_MagicCheck_Target_Item,//"目標物品( 機率 , 物品 or 重要物品 )"	
	EM_MagicCheck_Self_Buff,//"自己Buff( 機率 , 擁有某Buff )"			
	EM_MagicCheck_Target_Buff,//"目標Buff( 機率 , 擁有某Buff )"			
	EM_MagicCheck_Self_Position,//"自己位置( 機率 , 位置辨別碼 )"			
	EM_MagicCheck_Target_Position,//"目標位置( 機率 , 位置辨別碼 )"			
	EM_MagicCheck_Self_Fight,//"自己戰鬥( 機率 , 0非戰鬥/1戰鬥  )"		
	EM_MagicCheck_Target_Fight,//"目標戰鬥( 機率 , 0非戰鬥/1戰鬥  )"		
	EM_MagicCheck_Target_Race,//"目標種族( 機率 , 種族ID  )"			
	EM_MagicCheck_Self_HP,//"自己HP低於( 機率 , HP百分比 )"		
	EM_MagicCheck_Time,//"時間( 機率 , 時間 )"					
	EM_MagicCheck_Weather,//"氣候( 機率 , 氣候辨別碼 )"				
	EM_MagicCheck_Self_BuffGroup,//"自己Buff Group( 機率 , 擁有某Buff群組 )"			
	EM_MagicCheck_Target_BuffGroup,//"目標Buff Group( 機率 , 擁有某Buff群組 )"			
	EM_MagicCheck_Self_Skill,//"自己學會某技能( 機率 , 法術ID )"	
	EM_MagicCheck_BaseLv,//"需求等級( 機率 , LV )"	
